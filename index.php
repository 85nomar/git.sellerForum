    ...
    <div class="row-fluid">
      <div class="span4">
        ...
        <div class="row-fluid">
            ...
            <div class="span9">
                <p>We are announcing the launch of our new API developer site and the new ricardo API 2.0. Great news for sellers.</p>
                <p>Most importantly, this is just the beginning. We will continuously add new features, based on learnings from the users.</p>
      ...
      <div class="span4">
        <h3>API roadmap</h3>
          <div class="row-fluid">
              ...
              <div class="span9">
                  <p>The development of the API will be an ongoing process and you will find here the latest changes and updates which will be implemented during this summer.</p>
                  <p>In this first step, you will be able to get a better overview of the new documentation. Starting from July 1<sup>st</sup>, you will be able to connect to the new API 2.0</p>
                  <!-- <p><a class="btn-anchor" href="news.html"><i class="icon-angle-right"></i>View details</a></p> -->
              </div>
          </div>
      </div>
      <div class="span4">
        <h3>How to get access to the new API 2.0</h3>
          <div class="row-fluid">
              <div class="posted-date date-box span2">
                  <span class="month">Jun</span>
                  <span class="day">19</span>
