  ...
  <div class="content-bottom container">
    <div class="row-fluid">
      <div class="span4">
        ...
        <p>
            Today we are announcing the launch of our new API developer site and the new Ricardo API. Great news for Sellers, you will be able to connect your ERP to Ricardo platform with  a
        </p>
        <ul>
          <li>Simpler implementation.</li>
          <li>Clear documentation and code samples.</li>
